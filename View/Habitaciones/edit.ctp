...
<h2 id="input-groups-basic">Editar Habitacion</h2>
<?php 
	 echo $this->Form->create('Habitacione',array('action' => 'edit', 'id' => 'formulario','type' => 'file')); 
  ...
  <div class="col-md-6">
    ...
    <div class="col-md-6">
		    <div class="form-group">
	            <label>Activo</label>
				<?php 
                     // echo $this->Form->input('Habitacione.activo',array('label'=> false, 'class'=>'form-control'));
					   echo $this->Form->checkbox('Habitacione.activo', array('hiddenField' => false));
                ?>
	        </div>
		</div>
      	...
      	<div class="col-md-6">
		    <div class="form-group">
	            <label>Imagen</label>
				<?php 
                      echo $this->Form->input('imghabitacion', array('type' => 'hidden'));
