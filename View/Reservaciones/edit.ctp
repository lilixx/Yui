...
<div class="col-md-9">
		...
		<h2 id="input-groups-basic">Agregar Reservación</h2>
		
		<?php echo $this->Form->create('Reservacione',array('action' => 'edit', 'id' => 'formulario', 'role' => 'form')); ?>
...
<div class="row">
		...
		<div class="col-md-6">
			<div class="form-group">
	          ...
	          <?php echo $this->Form->input('Reservacione.cantninos',array('label'=>false,'placeholder'=>'Numero de niños', 'class'=>'form-control')); ?>
	        </div>
		</div>
		...
		<div class="col-md-6">
			<div class="form-group">
	              <?php	echo $this->Form->end(array('label' => 'Modificar Reserva','class' =>  'btn btn-default dropdown-toggle')); ?>        
	        </div>
		</div>
