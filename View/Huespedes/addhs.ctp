...
<div class="col-md-9">
		...
		<h2 id="input-groups-basic">Agregar Huésped</h2>
		
		<?php echo $this->Form->create('Huespede',array('action' => 'addhs', 'id' => 'formulario', 'role' => 'form')); ?>
    ...
    ================================================== -->
		...
		<div class="col-md-6">
			<div class="form-group">
	          ...
	          <?php echo $this->Form->input('Huespede.nombres',array('label'=>false,'placeholder'=>'Ingrese los nombres', 'class'=>'form-control')); ?>
	        </div>
		</div>
		...
		<div class="col-md-6">
			<div class="form-group">
	          ...
	          <?php echo $this->Form->input('Huespede.apellidos',array('label'=>false,'placeholder'=>'Ingrese los apellidos','class'=>'form-control')); ?>
	        </div>
		</div>
		...
		<div class="col-md-6">
	        ...
	        <?php echo $this->Form->input('Huespede.fechanacimiento',array('label'=>false,'type'=> "datepicker", 'id'=>"dob1",'readonly'=>"readonly", 'size'=>"5",'class'=>'form-control')); ?>
	        </div>
		</div>
		...
		<div class="col-md-6">
			<div class="form-group">
	          ...
	          <?php echo $this->Form->input('Huespede.estadocivil', array('label'=>false,'type'=>'select', 'options'=>array('------','soltero(a)'=>'soltero(a)', 'casado(a)'=>'casado(a)'), 'class'=>'form-control')); ?>
	        </div>
		</div>
		...
		<div class="col-md-6">
			<div class="form-group">
	          ...
	          <?php echo $this->Form->input('Huespede.nacionalidad',array('label'=>false,'placeholder'=>'Ingrese la nacionalidad', 'class'=>'form-control')); ?>
	        </div>
		</div>
		...
		<div class="col-md-6">
		    <div class="form-group">
	          ...
	          <?php echo $this->Form->input('Huespede.empresa',array('label'=>false,'placeholder'=>'Ingrese el nombre de la empresa', 'class'=>'form-control')); ?>
	        </div>
		</div>
...
<div class="col-md-6">
			<div class="form-group">
	              <?php	echo $this->Form->end(array('label' => 'Agregar huesped','class' =>  'btn btn-default dropdown-toggle')); ?>        
	        </div>
		</div>
