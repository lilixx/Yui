...
<div class="col-md-9">
		...
		<h2 id="input-groups-basic">Agregar Transporte</h2>
		
		<?php echo $this->Form->create('Cargo',array('action' => 'transporteadd', 'id' => 'formulario', 'role' => 'form')); ?>
	  ...
	  <div class="col-md-6">
			<div class="form-group">
	          <label for="exampleInputEmail1">Categoria</label>
	            <?php echo $this->Form->select('Cargocategoria.0.categoria_id',$CategoriasArray, array('label'=>false,'placeholder'=>"categoria", 'class'=>'form-control', 'required'=>"required")); ?> <br/>
   	...
   	<div class="col-md-6">
		...
		<div class="col-md-6">
			<div class="form-group">
	              <?php	echo $this->Form->end(array('label' => 'Agregar Transporte','class' =>  'btn btn-default dropdown-toggle')); ?>        
	        </div>
		</div>
