...
<div class="col-md-9">
		...
		<h2 id="input-groups-basic">Agregar Pedido</h2>
		
		<?php echo $this->Form->create('Cargo',array('action' => 'pedidoadd', 'id' => 'formulario', 'role' => 'form')); ?>
...
<div class="row">
		...
		<div class="col-md-6">
			<div class="form-group">
	              <?php	echo $this->Form->end(array('label' => 'Agregar Pedido','class' =>  'btn btn-default dropdown-toggle')); ?>        
	        </div>
		</div>
