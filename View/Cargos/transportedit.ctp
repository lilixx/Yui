...
<div class="col-md-9">
		...
		<h2 id="input-groups-basic">Editar Transporte</h2>
		
		<?php echo $this->Form->create('Cargo',array('action' => 'transportedit', 'id' => 'formulario', 'role' => 'form')); ?>
	...
	<?php   echo $this->Form->input('id', array('type' => 'hidden')); ?> 
	  ...
	  <div class="col-md-6">
   	...
   	<div class="col-md-6">
		...
		<div class="col-md-6">
			<div class="form-group">
	              <?php	echo $this->Form->end(array('label' => 'Editar Transporte','class' =>  'btn btn-default dropdown-toggle')); ?>        
	        </div>
		</div>
