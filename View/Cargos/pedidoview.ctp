 ...
 <div class="row">
  ...
  <div class="col-md-6">
    <div class="form-group">
      <a href="/Cargos/pedidoadd/"class="btn btn-primary">Agregar Pedido</button></a>
    </div>
   </div>
...
<table class="table table-bordered">
   ...
   |
   <a href="/Cargos/pedidoedit/<?php echo $car['Cargo']['id']; ?>" TITLE="Editar Pedido"><span class="glyphicon glyphicon-pencil"></span></a> 	
			      | 
			<?php	  echo $this->Form->postLink('<span class="glyphicon glyphicon-remove" title="Dar de baja" />',
			                                   array('action' => 'baja/' . $car['Cargo']['id'] . '?tipo=1'),
			                                   array('escape'=>false, 'confirm' => '¿Desea dar de baja al Pedido?'));    										
			   	  echo " | ";   
			  ?>
