...
<div class="col-md-9">
		...
		<h2 id="input-groups-basic">Editar Promoción</h2>
		
		<?php echo $this->Form->create('Cargo',array('action' => 'promocionedit', 'id' => 'formulario', 'role' => 'form')); ?>
	...
	<div class="col-md-6">
	 ...
	 <div class="col-md-6">
   	...
   	<div class="col-md-6">
		...
		<div class="col-md-6">
			<div class="form-group">
	              <?php	echo $this->Form->end(array('label' => 'Editar Promoción ','class' =>  'btn btn-default dropdown-toggle')); ?>        
	        </div>
		</div>
