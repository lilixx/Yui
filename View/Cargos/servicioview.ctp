 ...
 <div class="row">
  ...
  <div class="col-md-6">
    <div class="form-group">
      <a href="/Cargos/servicioadd/"class="btn btn-primary">Agregar Servicio</button></a>
    </div>
   </div>
...
<table class="table table-bordered">
   ...
   |
   <a href="/Cargos/servicioedit/<?php echo $car['Cargo']['id']; ?>" TITLE="Editar Servicio"><span class="glyphicon glyphicon-pencil"></span></a> 	
			      | 
			<?php	  echo $this->Form->postLink('<span class="glyphicon glyphicon-remove" title="Dar de baja" />',
			                                   array('action' => 'baja/' . $car['Cargo']['id'] . '?tipo=2'),
			                                   array('escape'=>false, 'confirm' => '¿Desea dar de baja al Servicio?'));    										
			   	  echo " | ";   
			  ?>
