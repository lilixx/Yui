 ...
 <div class="row">
  ...
  <div class="col-md-6">
    <div class="form-group">
      <a href="/Cargos/promocioneadd/"class="btn btn-primary">Agregar Promoción </button></a>
    </div>
   </div>
...
<table class="table table-bordered">
   ...
   |
   <a href="/Cargos/promocionedit/<?php echo $car['Cargo']['id']; ?>" TITLE="Editar Promoción "><span class="glyphicon glyphicon-pencil"></span></a> 	
			      | 
			<?php	  echo $this->Form->postLink('<span class="glyphicon glyphicon-remove" title="Dar de baja" />',
			                                   array('action' => 'baja/' . $car['Cargo']['id'] . '?tipo=3'),
			                                   array('escape'=>false, 'confirm' => '¿Desea dar de baja a la Promoción?'));    										
			   	  echo " | ";   
			  ?>
