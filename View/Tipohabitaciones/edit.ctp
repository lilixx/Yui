...
<h2 id="input-groups-basic">Editar Tipo de habitacion</h2>
		
		<?php echo $this->Form->create('Tipohabitacione',array('action' => 'edit')); ?>
          ...
          <div class="col-md-6">
		    <div class="form-group">
				...
				<?php 
					   ...
					   echo $this->Form->checkbox('Tipohabitacione.activo', array('hiddenField' => false));
                ?>
	        </div>
		</div>
