...
<div class="col-md-9">
		...
		<h2 id="input-groups-basic">Editar Categoria</h2>
		
		<?php echo $this->Form->create('Categoria',array('action' => 'edit', 'id' => 'formulario', 'role' => 'form')); ?>
...
<div class="row">
	...
	<?php   echo $this->Form->input('id', array('type' => 'hidden')); ?> 
		...
		<div class="col-md-6">
			<div class="form-group">
	              <?php	echo $this->Form->end(array('label' => 'Editar Categoria','class' =>  'btn btn-default dropdown-toggle')); ?>        
	        </div>
		</div>
